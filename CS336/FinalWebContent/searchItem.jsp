...
if(result.first()){
	...
	%><h1 style="text-align:center; font-size:40px">Searched Items</h1><%

	%> 
	<div style = "text-align:center; font-size:25px" class="item">
	<a style="margin-bottom:20px; text-decoration: none; color:gray" href="itemDetails.jsp?idItem=<%=result.getString("item_id")%>"> Title: <%=result.getString("title")%> Name of Pet: <%=result.getString("name")%></a>
	</div>
	<%
